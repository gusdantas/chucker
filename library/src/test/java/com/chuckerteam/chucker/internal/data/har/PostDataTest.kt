...
internal class PostDataTest {
    @Test
    fun responsePostData_createPostDataWithCorrectSize() {
    ...
    @Test
    fun responsePostData_createPostDataWithCorrectMimeType() {
        val transaction = TestTransactionFactory.createTransaction("GET")
        val postData = PostData.responsePostData(transaction)
    ...
    @Test
    fun responsePostData_returnsNullWhenPayloadSizeIsNull() {
        val transaction = TestTransactionFactory.createTransaction("GET")
    ...
    @Test
    fun requestPostData_createPostDataWithCorrectSize() {
        val transaction = TestTransactionFactory.createTransaction("GET")
